...
exports.baseInstructions = baseInstructions;
exports.toolsetCapabilities = toolsetCapabilities;
...
function toolsetCapabilities(mode) {
    const caps = {
...
function merchantContextBlock(parts) {
    const lines = [
