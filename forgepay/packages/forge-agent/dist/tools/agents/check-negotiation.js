...
registry_1.registry.register({
    definition: {
        ...
        description: "Get the status and agreed terms of a negotiation session. Use after start_negotiation to see if the other agent has responded.",
        input_schema: {
            type: "object",
            properties: {
...
//# sourceMappingURL=check-negotiation.js.map