...
registry_1.registry.register({
    definition: {
        name: "redeem_rwa",
        description: "⚠️ REQUIRES APPROVAL. Submit a redemption request for an RWA position. Funds will be returned to the merchant's USDC wallet based on the asset's redemption speed (instant to T+5).",
        input_schema: {
            type: "object",
            properties: {
...
//# sourceMappingURL=redeem-rwa.js.map