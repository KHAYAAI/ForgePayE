...
registry_1.registry.register({
    definition: {
        name: "get_rwa_income",
        description: "Get income distribution history and tax liability summary for RWA positions. Shows interest, dividends, and coupons earned, with tax treatment breakdown (ordinary_income, qualified_dividend, capital_gain).",
        input_schema: {
            type: "object",
            properties: {
...
//# sourceMappingURL=get-rwa-income.js.map